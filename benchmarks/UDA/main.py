...
if __name__ == "__main__":
    ...
    #'SMA_UniDA_5x25_v2',
    # ========  Experiments Name ================
    parser.add_argument('--save_dir',               default='SMA_results/',         type=str, help='Directory containing all experiments')
    parser.add_argument('--exp_name',               default='EXP1',         type=str, help='experiment name')

    # ========= Select the DA methods ============
    parser.add_argument('--da_method',              default='DANCE',               type=str, help='NO_ADAPT, Deep_Coral, DeepJDOT, MMDA, DANN, CDAN, DIRT, DSAN, HoMM, CoDATS, AdvSKM, SASA, CoTMix, TARGET_ONLY')

    # ========= Select the DATASET ==============
    parser.add_argument('--data_path',              default=r'./data',                  type=str, help='Path containing datase2t')
    parser.add_argument('--dataset',                default='BIRDS',                      type=str, help='Dataset of choice: (WISDM - EEG - HAR - HHAR_SA)')

    # ========= Select the BACKBONE ==============
    parser.add_argument('--backbone',               default='ResNet50Fc',                      type=str, help='Backbone of choice: (CNN - RESNET18 - TCN)')
